                            ...
                            <Card key={item.id} className="border-none shadow-sm overflow-hidden">
                                <CardContent className="p-0">
                                    ...
                                    <div className="p-4 pb-2">
                                        <div className="flex items-start justify-between">
                                            <div className="flex items-start gap-2">
                                                ...
                                                <div>
                                                    <Link href={`/p/${item.user.id}`} className="hover:underline">
                                                        <p className="font-semibold text-sm text-gray-900">{item.user.name}</p>
                                                    </Link>
                                                    <p className="text-xs text-gray-500 line-clamp-1">{item.user.headline}</p>
                                                    <p className="text-xs text-gray-400 flex items-center gap-1">
                                                        {new Date(item.createdAt).toLocaleDateString()} · <Globe className="w-3 h-3" />
                                                    </p>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                {userProfile?.id === item.user.id ? (
                                                    ...
                                                    <>
                                                        <Button variant="ghost" size="sm" className="text-blue-600 text-xs gap-1 h-7">
                                    ...
                                    <div className="px-4 pb-2">
                                        <p className="text-sm text-gray-800 whitespace-pre-wrap">{item.data.content}</p>
                                    </div>
                                    ...
                                    {item.data.image && (
                                        <div className="w-full relative">
                                            <Image
                                                ...
                                                loading="lazy"
                                                unoptimized={item.data.image.startsWith('blob:')}
                                            />
                                        </div>
                                    )}
                                    ...
                                    <div className="px-4 py-2 flex items-center justify-between text-xs text-gray-500">
                                        <div className="flex items-center gap-1">
                                            ...
                                            <span>{item.congratulations || 0}</span>
                                        </div>
                                    ...
                                    <div className="px-4 py-1 flex justify-between">
                                        <Button
                                            variant="ghost"
                                            size="sm"
                                            className={cn("text-xs gap-1.5 flex-1 hover:bg-gray-100", item.liked ? "text-blue-600" : "text-gray-600")}
                                            onClick={() => handleLike(item.id)}
                                        >
                                            <ThumbsUp className={cn("w-4 h-4", item.liked && "fill-current")} /> Like
                                        </Button>
                                        <Button variant="ghost" size="sm" className="text-gray-600 text-xs gap-1.5 flex-1 hover:bg-gray-100">
